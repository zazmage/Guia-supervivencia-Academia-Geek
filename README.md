# Guia-supervivencia-Academia-Geek
El siguiente es un markdown que contiene una guía de supervivencia con un compendio de las temáticas a estudiar y los recursos a mi parecer más adecuados para ello.
...
- Para aquellos más familiarizados con Javascript les recomiendo directamente aprender los conceptos que no sepan y practicar con los diferentes retos y sprints del curso, practiquen sin miedo sobre los proyectos que van a entregar.
...
- Los temas clave son los temas que considero necesarios para desemvolverse adecuadamente y sin matarse tanto en los proyectos del curso, siempre se puede profundizar o aprender temáticas adicionales pero tenga en cuenta... **ES UN INTENSIVO MUY JODIDO!** 
...
- Concepto de programación asíncrona (Muy importante)
- Callbacks
- Promesas
- Funciones asincronas
- Concepto de programación funcional (Importante)
- Map
- Filter
- Search
- Reduce
...
**Concepto de peticiones a APIS web:** Video 105 al 110 **Enlace video 105:** https://www.youtube.com/watch?v=lN43CTpbWTU&list=PLvq-jIkSeTUZ6QgYYO3MwG9EMqC-KoLXA

**API REST:** Video 111 al 118 **Enlace video 111:** https://www.youtube.com/watch?v=wzoUu6rcQ4c&list=PLvq-jIkSeTUZ6QgYYO3MwG9EMqC-KoLXA
...
- Concepto de peticiones a APIs web (Demoniacamente importante)
- API Fetch
- Async-Await
- Axios
- APIs REST (Muy importante)
- CRUD
...
- Propiedades
- Estados (Vital - Indispensable - Demencialmente importante)
- Eventos
- Comunicación entre componentes (Muy importante)
- Ciclo de vida de los componentes (Importante)
- Peticiones Asíncronas (Muy importante)
- Hooks (Importantisimo)
...
Durante el curso se ven diferentes implementaciones, despliegues y demás servicios de internet para trabajar en nuestros proyectos, las temáticas como firebase, cloudinary, json-server, formik, bootstrap, entre otras las considero "añadiduras" y considero que la explicación que recibirán por parte de los mentores de estas temáticas será satisfactoria por lo que no adjuntaré mas recursos en ese aspecto, bueno... si, quizas solo un pequeño tutorial de Firebase te sea de ayuda.

**Instalación de firebase v9:** https://www.youtube.com/watch?v=s_Txhh-clVk
**Despliegue del app con firebase host:** https://medium.com/swlh/how-to-deploy-a-react-app-with-firebase-hosting-98063c5bf425

No siendo más les deseo suerte en su bootcamp y un futuro lleno de excesos y dinero, los quiero mucho... *Daniel Castaño*
